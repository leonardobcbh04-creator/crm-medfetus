        ...
        {examConfigs.map((examConfig) => (
          <form key={examConfig.id} className="panel-card stack-form" onSubmit={(event) => handleSubmit(event, examConfig)}>
            ...
            <div className="three-columns">
              <label>
                Semana inicial
                <input name="startWeek" type="number" step="0.01" defaultValue={examConfig.startWeek} />
              </label>

              <label>
                Semana final
                <input name="endWeek" type="number" step="0.01" defaultValue={examConfig.endWeek} />
              </label>

              <label>
                Semana alvo
                <input name="targetWeek" type="number" step="0.01" defaultValue={examConfig.targetWeek} />
              </label>
            </div>
