    ...
    <section className="page-section">
      ...
      <div className="messages-grid">
        {filteredItems.map((item) => {
          ...
          const whatsappUrl = `https://wa.me/${item.phone}?text=${encodeURIComponent(draftMessage)}`;
          ...
          return (
            ...
            >
              ...
              <div className="message-actions list-action-bar">
                ...
                <button className="secondary-button" type="button" onClick={() => handleRegisterSend(item)}>
                  Registrar envio
                </button>
